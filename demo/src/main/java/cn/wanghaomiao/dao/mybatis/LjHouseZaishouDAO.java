...
public interface LjHouseZaishouDAO {
	...
	@Insert("insert into ljhouse_zaishou (title,totalprice,unitprice,roommaininfo,roomsubinfo,typemaininfo,typesubinfo,areamaininfo,areasubinfo,community,position1,position2,position3,position4,content,update_time) "
